...
void tankSelectionScreen() {
    ...
    // M5.Lcd.fillCircle(screenWidth/2, screenHeight * 1/3 + 45, 40, tankColor[1]);
    // M5.Lcd.drawCircle(screenWidth/2, screenHeight * 1/3 + 45, 40, BLACK);
    
    // //M5.Lcd.setTextSize(2);
    // M5.Lcd.setCursor(screenWidth/2 - tankName[1].length()*5*3/2, screenHeight/2 + 65);
    // M5.Lcd.setTextColor(tankColor[1]);
